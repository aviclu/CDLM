...
from src.dataset_g_pla import MyDataset
import argparse
import shutil
import csv
import numpy as np
...
def get_args():
    ...
    parser.add_argument("--pos_path", type=str, default='')
...
def test(opt):
    ...
    test_set = MyDataset(opt.data_path, opt.pos_path, opt.word2vec_path, max_sent_length, max_word_length)
